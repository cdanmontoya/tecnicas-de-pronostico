...
mod.exponencial_lineal = lm(lny ~ t + It)
mod.exponencial_cuadratico <- lm(lny ~ t + I(t2) + It)
...
M.hw = medidas.hw(y, ts(forecast(mod.hw,h=12)$mean, frequency = 12), m)
M.nnar = medidas.hw(y, ts(forecast(mod.nnar,h=12)$mean, frequency = 12), m)
